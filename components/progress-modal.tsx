...
const statusConfig = {
  ...
  downloading: { icon: Loader2, color: 'text-blue-500', bgColor: 'bg-blue-100' },
  ...
  cancelled: { icon: AlertCircle, color: 'text-orange-500', bgColor: 'bg-orange-100' },
};
...
export function ProgressModal({
  ...
  const isCompleted = status === 'success' || status === 'error' || status === 'cancelled';
